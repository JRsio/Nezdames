...
public class GenererPdfContratTravail {
  ...
  public GenererPdfContratTravail(int indiceDuContratTravailAEditer) {
    try {
      leContrat = NezDamesSerialisation.lesContratsCession.get(indiceDuContratTravailAEditer);
      FILE = "ContratsCession/ContratDeCession-"+NezDamesSerialisation.lesContrat.get(indiceDuContratTravailAEditer).getNumeroContratTravail()+".pdf";
  ...
  private static void ajoutContenu(Document document) throws DocumentException, BadElementException, IOException {
    ...
    subCatPart.add(new Paragraph("       Nom, prénom, pseudonyme : ROUSSEL Michel dit Léon"));
    subCatPart.add(new Paragraph("       Adresse : "+"     NAF : Le Calistou – Les Aigladines\n" + "30140 MIALET"));
    subCatPart.add(new Paragraph("       Date et lieu de naissance : 15/01/1957 à HONFLEUR (14)"));
    subCatPart.add(new Paragraph("       Nationalité : "+"    FRANCAISE. :"));
