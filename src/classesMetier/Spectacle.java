...
public class Spectacle implements Serializable {
    ...
    public Spectacle(String numeroObjet, int duree, String titre, int anneeCreation, double prixVenteTheorique, String fichierContraintesTechniques, String fichierSynopsis, ArrayList<Intermittent> listeDroite) {
